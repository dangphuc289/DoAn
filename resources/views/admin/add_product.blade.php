	...
	?>
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" style="resize: none" rows="5" name="product_desc" id="exampleInputPassword1" placeholder="Mô tả danh mục"></textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="product_number" class="form-control" id="exampleInputEmail1" placeholder="Số lượng">
                                </div>
                                <div class="form-group">
